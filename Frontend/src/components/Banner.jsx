  ...
  return (
    ...
    <div className='max-w-screen-2xl container mx-auto md: px-6 px-4 flex flex-col md:flex-row my-10'>
        ...
        <div className='order-1 w-full md:w-1/2'>
          <img src={banner} className = "w-73 h-73" alt="" />
          </div>
    </div>
